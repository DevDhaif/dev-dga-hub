---
description: 'قائمة إجراءات منسدلة في React مبنية على Radix بعناصر ومربّعات اختيار وأزرار اختيار وتسميات وفواصل وقوائم فرعية وفتحات نهائية. دعم كامل للوحة المفاتيح والاتجاه العربي.'
seoTitle: 'قائمة إجراءات: مكوّن DropdownMenu متاح الوصول (Radix)'
---
