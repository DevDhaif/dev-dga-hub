---
description: 'صورة رمزية في React بصورة وبديل من الأحرف الأولى وأحجام وأشكال ونقطة حالة ومجموعات متراصّة مع فائض +N. الأسماء المتاحة مدمجة.'
seoTitle: 'صورة رمزية: مكوّن Avatar ببديل نصّي ومجموعات'
---
...
استخدم Avatar لتمثيل شخص أو جهة في الترويسات والتعليقات والمخطّطات الزمنية والجداول. وفّر `AvatarFallback` بالأحرف الأولى للصور الناقصة.

استخدم `AvatarGroup` لعرض عدّة مشاركين بإيجاز، وقيّد المجموعة لتبقى مقروءة.
...
يعرض Avatar الدور `role="img"` باسم متاح من `alt` أو نص البديل. نقطة الحالة زخرفية، فاذكر الحالة نصًّا قريبًا حين تهمّ.

تعلن المجموعات عدد الفائض نصًّا لا بعرض «+N» بصريًا فقط.
