---
description: 'منطقة إظهار وإخفاء واحدة في React مبنية على Radix، بزر مشغّل من عندك، وخيار الفتح افتراضيًا، ونمط بسهم.'
seoTitle: 'قابل للطي: مكوّن Collapsible إظهار وإخفاء (Radix)'
---
...
يعرض المشغّل `aria-expanded` و`aria-controls`، فتُعلن حالته وهدفه. يبدّله Space وEnter.
