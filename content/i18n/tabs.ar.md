---
description: 'تبويبات متاحة الوصول في React مبنية على Radix بقائمة تبويب متنقّلة وأيقونات وأنماط بعرض كامل ومسطّحة ومعالجة للفائض وتسميات عربية. تنقل مفاتيح الأسهم بين التبويبات.'
seoTitle: 'تبويبات: مكوّن Tabs متاح الوصول بقائمة تبويب متنقّلة'
---
...
تتّبع Tabs نمط التبويبات: `role="tablist"` و`role="tab"` و`role="tabpanel"` مع عرض التبويب المحدّد. تنقل مفاتيح الأسهم التركيز بين التبويبات، ويقفز Home وEnd إلى الطرفين، وتتبع مفاتيح الأسهم اتجاه القراءة في العربية.
